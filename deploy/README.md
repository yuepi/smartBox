...
- 商户侧不再注册 `HousekeepingPartners`，平台 `HousekeepingRelations` 保留；不改变后端接口权限或合作数据。
- 发布包：`outputs/pc-test-20260921-menu.tar.gz`，SHA-256：`ffa07251f19bf3d44205a530382d9c4a668b1ec69b4a828403affd5c73d5a88f`。
- 旧版及配置备份：`/www/backup/pc-menu-20260921-3uw4aL`，原静态文件位于 `dist-before`。
- 首页 SHA-256：`5458aa58d0610044e2981c78465122b300206d8bebd8bb8bf7798d5f19dca09b`。
- 测试接口仍为 `/api`，代理 `127.0.0.1:8342`；未发布 JAR、未修改数据库、Nginx 或正式环境。
