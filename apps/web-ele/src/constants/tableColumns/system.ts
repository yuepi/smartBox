...
export const defaultOperLogColumns: TableColumnConfig[] = [
  ...
  { key: 'operAccountName', label: '操作人', visible: true, width: 200, align: 'center' },
  { key: 'operAccountType', label: '操作人类型', visible: true, width: 150, align: 'center' },
  { key: 'operIp', label: '操作IP', visible: true, width: 150, align: 'center' },
