...
export const defaultMemberWithdrawColumns: TableColumnConfig[] = [
  { key: 'memberWithdrawId', label: '提现ID', visible: false, width: 80, align: 'center' },
  { key: 'withdrawNo', label: '提现单号', visible: true, minWidth: 180, align: 'center', showOverflowTooltip: true, fixed: 'left' },
  ...
  { key: 'memberPhone', label: '手机号', visible: true, minWidth: 130, align: 'center' },
  { key: 'merchantId', label: '商户ID', visible: false, width: 80, align: 'center' },
  { key: 'applyAmount', label: '申请金额', visible: true, width: 120, align: 'end' },
  { key: 'recentOrder', label: '近期订单', visible: true, width: 120, align: 'center' },
  { key: 'platformFee', label: '服务费', visible: true, width: 100, align: 'end' },
  { key: 'realWithdrawAmount', label: '实际到账', visible: true, width: 120, align: 'end' },
  ...
  { key: 'auditReason', label: '审核原因', visible: true, minWidth: 150, align: 'start', showOverflowTooltip: true },
