...
export const defaultRecycleOrderColumns: TableColumnConfig[] = [
  { key: 'recycleOrderId', label: '订单ID', visible: false, width: 80, align: 'center' },
  ...
  { key: 'beforeWeight', label: '投递前重量(kg)', visible: false, width: 120, align: 'center' },
  { key: 'afterWeight', label: '投递后重量(kg)', visible: false, width: 120, align: 'center' },
  ...
  { key: 'realWeight', label: '实际有效重量(kg)', visible: true, width: 140, align: 'center' },
  { key: 'unitPrice', label: '回收单价(元/kg)', visible: true, width: 140, align: 'center' },
