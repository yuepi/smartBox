...
export const defaultMenuColumns: TableColumnConfig[] = [
  { key: 'menuName', label: '菜单名称', visible: true, width: 500, align: 'start', fixed: 'left', showOverflowTooltip: true },
  { key: 'menuType', label: '类型', visible: true, width: 100, align: 'center' },
  { key: 'platformType', label: '归属', visible: true, width: 200, align: 'center' },
  { key: 'path', label: '路由地址', visible: true, width: 250, align: 'start', showOverflowTooltip: true },
  { key: 'component', label: '组件路径', visible: false, width: 300, align: 'start', showOverflowTooltip: true },
  { key: 'code', label: '权限标识', visible: true, width: 300, align: 'start', showOverflowTooltip: true },
...
export const defaultDeptColumns: TableColumnConfig[] = [
  ...
  { key: 'deptName', label: '部门名称', visible: true, width: 600, align: 'start', fixed: 'left' },
