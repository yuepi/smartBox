...
export const defaultMerchantFlowColumns: TableColumnConfig[] = [
  ...
  { key: 'changeAmount', label: '变动金额', visible: true, width: 120, align: 'end' },
  { key: 'beforeBalance', label: '变动前余额', visible: true, width: 120, align: 'end' },
  { key: 'afterBalance', label: '变动后余额', visible: true, width: 120, align: 'end' },
  { key: 'relatedId', label: '关联业务ID', visible: true, width: 100, align: 'center' },
  { key: 'remark', label: '备注', visible: true, minWidth: 180, align: 'start', showOverflowTooltip: true },
...
export const defaultMerchantColumns: TableColumnConfig[] = [
  ...
  { key: 'merchantName', label: '商户名称', visible: true, minWidth: 180, align: 'start', fixed: 'left', showOverflowTooltip: true },
