  ...
  <div v-loading="loading" class="config-form">
    <el-form v-if="configData" :model="configData" label-width="220px" label-position="right">
      ...
      <el-form-item v-if="showOrderWalletSync" label="回收订单审核方式">
        <el-select v-model="configData.orderWalletSync" placeholder="请选择" style="width: 100%" :disabled="readonly">
      ...
      <el-form-item label="用户首次订单免审核">
        <el-radio-group v-model="configData.firstOrderNoAudit" :disabled="readonly">
      ...
      <el-form-item label="自动审核开关">
        <el-radio-group v-model="configData.autoAuditEnabled" :disabled="readonly">
      ...
      <el-form-item>
        <el-button v-if="!readonly" type="primary" :loading="submitting" @click="handleSave">保存配置</el-button>
