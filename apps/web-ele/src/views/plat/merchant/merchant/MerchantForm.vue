...
async function open(row?: Merchant) {
  ...
  if (row?.merchantId) {
    ...
    title.value = '新增商户';
    formData.value = { status: 0, merchantMenuIds: [], provinceCode: '', cityCode: '', districtCode: '' };
    location.value = null;
    areaCodes.value = '';
  }
...
<template>
  <el-dialog v-model="visible" :title="title" width="1400px" append-to-body @close="resetForm">
