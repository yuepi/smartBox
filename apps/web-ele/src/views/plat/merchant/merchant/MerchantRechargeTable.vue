    ...
    <el-card shadow="never" class="border-none mb-4 !p-2">
      ...
      >
        <el-form-item class="!mb-0 !mr-2">
          ...
          >
            <template #prefix>
              <span class="text-xs text-gray-400 mr-0.5">充值单号:</span>
            </template>
          </el-input>
        </el-form-item>
        ...
        <el-form-item class="!mb-0 !mr-2">
          ...
          >
            <template #prefix>
              <span class="text-xs text-gray-400 mr-0.5">退款状态:</span>
            </template>
            <el-option
    ...
    >
      <el-descriptions :column="2" border v-if="detailData">
        ...
        <el-descriptions-item label="支付状态">
          <el-tag :type="getPayStatusType(detailData.status)" size="small">
            {{ getPayStatusText(detailData.status) }}
          </el-tag>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="退款状态">
          <el-tag
            :type="getRefundStatusType(detailData.refundStatus)"
            size="small"
          >
