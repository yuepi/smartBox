...
import { deletePlatLoginLogApi, getPlatLoginLogDetailApi, getPlatLoginLogPageApi } from "#/api/monitor/login";
...
async function handleView(row: any) {
  try {
    const res = await getPlatLoginLogDetailApi(row.loginLogId);
...
async function handleDelete() {
  ...
  try {
    ...
    await deletePlatLoginLogApi(ids);
