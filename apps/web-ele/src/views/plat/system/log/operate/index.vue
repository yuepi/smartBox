...
import { deletePlatOperLogApi, getPlatOperLogPageApi } from '#/api/monitor/oper';
import { defaultOperLogColumns, OPER_LOG_STORAGE_KEY } from '#/constants/tableColumns';
import { ModuleCodeMap } from '#/hooks/useExport';

const { log_business_type, log_account_type, log_oper_status } = useDicts(['log_business_type', 'log_account_type', 'log_oper_status']);
      ...
      <template v-if="detailData">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="业务类型">
            <DictTag :options="log_business_type" :value="detailData.businessType" />
          </el-descriptions-item>
          <el-descriptions-item label="操作人">{{ detailData.operAccountName }}</el-descriptions-item>
          <el-descriptions-item label="操作人类型">
            <DictTag :options="log_account_type" :value="detailData.operAccountType" />
          </el-descriptions-item>
