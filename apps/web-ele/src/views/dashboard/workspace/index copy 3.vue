...
const quickNavItems: WorkbenchQuickNavItem[] = [
  ...
  { color: '#3fb27f', icon: 'lucide:clipboard-list', title: '回收订单', url: '/recycleOrder' },
  ...
  { color: '#e18525', icon: 'ion:layers-outline', title: '分拣订单', url: '/sortTask' },
];
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
      ...
      <div class="bg-white dark:bg-zinc-800 p-4 rounded-xl border border-gray-100 dark:border-zinc-700 shadow-sm flex flex-col justify-between">
        <div class="flex justify-between items-center mb-3">
          ...
          <el-tag type="success" round>在线率 {{ onlineRate }}%</el-tag>
        </div>
