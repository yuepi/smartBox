      ...
      <el-card shadow="never">
        ...
        >
          ...
          <el-table-column
            ...
            align="center"
          >
            <template #default="{ row }"> {{ row.waitTime }} s </template>
          </el-table-column>
          <el-table-column
            prop="lightType"
            label="灯光类型"
      ...
      <el-form :model="formData" label-width="120px">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="满仓重量阈值">
              <el-input-number
                v-model="formData.fullWeightThreshold"
                :min="0"
                :max="1000"
                style="width: 100%"
              />
        ...
        <el-form-item label="灯光类型">
          <el-radio-group v-model="formData.lightType">
            <el-radio
              v-for="item in lightTypeOptions"
              :key="item.value"
              :value="item.value"
            >
              {{ item.label }}
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="灯光开始时间">
              <el-time-select
                v-model="formData.lightStartTime"
                start="00:00:00"
                step="00:30:00"
                end="23:59:59"
                placeholder="选择时间"
