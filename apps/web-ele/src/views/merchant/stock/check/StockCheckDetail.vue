      ...
      <el-descriptions :column="2" border v-if="detailData">
        ...
        <el-descriptions-item label="盘盈总重">
          <span class="text-success"
            >{{ detailData.totalProfitWeight?.toFixed(2) || 0 }} kg</span
          >
        </el-descriptions-item>
        <el-descriptions-item label="盘亏总重">
          <span class="text-danger"
            >{{ detailData.totalLossWeight?.toFixed(2) || 0 }} kg</span
          >
        </el-descriptions-item>
      ...
      <div class="mt-4">
        <div class="flex items-center justify-between mb-2">
          ...
          <span class="text-xs text-gray-400">
            ...
            kg | 盘亏:
            <span class="text-danger">{{ summary.totalLoss.toFixed(2) }}</span>
            kg
          </span>
        </div>
