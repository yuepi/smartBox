  ...
  <div class="recharge-table">
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex items-center">
        <ColumnSelector :storage-key="MERCHANT_RECHARGE_STORAGE_KEY" :default-columns="defaultMerchantRechargeColumns"
    ...
    <el-dialog v-model="refundVisible" title="订单退款" width="450px" append-to-body>
      <el-form label-width="100px">
        ...
        <el-form-item label="退款金额" required>
          <el-input-number v-model="refundAmount" :min="0.01" :precision="2" :step="10" :max="currentOrder?.amount"
