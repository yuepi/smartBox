    ...
    <div class="p-4">
      ...
      <el-card shadow="never" class="mb-4">
        <el-form :inline="true" :model="queryParams">
          ...
          <el-form-item>
            <el-button type="primary" :icon="Search" @click="handleQuery" v-access:code="['merchant:role:page']">查询</el-button>
            <el-button :icon="Refresh" @click="resetQuery" v-access:code="['merchant:role:page']">重置</el-button>
            <el-button type="primary" plain :icon="Plus" @click="handleAdd()" v-access:code="['merchant:role:add']">新增</el-button>
            <el-button type="danger" plain :icon="Delete" :disabled="selectedIds.length === 0" @click="handleDelete()" v-access:code="['merchant:role:del']">
              批量删除
            </el-button>
          </el-form-item>
        </el-form>
      ...
      <el-card shadow="never">
        <el-table v-loading="loading" :data="tableData" border style="width: 100%"
          ...
          <el-table-column label="操作" width="150" fixed="right" align="center">
            <template #default="{ row }">
              <el-button link type="primary" :icon="Edit" @click="handleEdit(row)" v-access:code="['merchant:role:edit']">编辑</el-button>
              <el-button link type="danger" :icon="Delete" @click="handleDelete(row)" v-access:code="['merchant:role:del']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
