...
<template>
  <Page auto-content-height content-class="p-2">
    <Splitpanes class="default-theme">
      <Pane size="15">
        <ViewTree :api="getMerchantDeptListApi" tip="输入部门名称检索" node-key="deptId" label-key="deptName"
      ...
      <Pane size="85">
        <BaseTableLayout v-model:query-params="queryParams" v-model:more-params="moreParams" :loading="loading"
          ...
          <template #toolbar-left>
            <el-button type="primary" :icon="Plus" @click="handleAdd" v-access:code="['merchant:user:add']">
              新增用户
            </el-button>
