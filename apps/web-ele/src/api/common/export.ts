...
export function delExportTasksApi(exportId: number) {
  return requestClient.post('/merchant/exportTask/delExportTasks', {
    exportId,
  });
}
...
export function onceAgainExportExcelApi(exportId: number) {
  return requestClient.post('/merchant/exportTask/onceAgainExportExcel', {
    exportId,
  });
}
