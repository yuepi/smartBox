...
/** 提现状态枚举 */
export const WithdrawStatusMap: Record<
  number,
...
export function getMemberWithdrawDetailApi(memberWithdrawId: number) {
  return requestClient.get('/merchant/memberWithdraw/detail', {
    params: { memberWithdrawId },
  });
}
...
export function deleteMemberWithdrawApi(memberWithdrawId: number) {
  return requestClient.post('/merchant/memberWithdraw/delete', {
    memberWithdrawId,
  });
}
